...
<main class="container col-12 col-lg-8 text-light">
    <div class="row col-12">
        <div class="col-12">
            ...
            <div class="paragrafo-artigo">
                <p>A seguir veja os grupos que ganharam os três primeiros lugares:</p>
            </div>
            <div class="paragrafo-artigo">
                <h4>3° lugar: Espelho infinito com led</h4>
            ...
            <div class="paragrafo-artigo">
                <h4>2° lugar: Pinça cirúrgica fantasma</h4>
