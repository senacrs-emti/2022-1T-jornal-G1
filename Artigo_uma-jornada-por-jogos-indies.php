...
<main class="container col-12 col-lg-8 text-light">
    <div class="row col-12">
        <div class="col-12">
            <h1 class="font-weight-bold mt-4 titulo">Uma jornada por jogos indies</h1>
            <h6 class="font-weight-normal subtitulo">Jogos são algo extremamente consumido e lucrativo nos dias de hoje, mas voçê sabe o que são jogos indies?</h6>
            <div class="pt-4">
                <p class="text-light float-left"><strong>ROBERTO LEITÃO</strong> Estudante</p>
                <b class="text-muted float-right">29/11/2022 - 15:05</b>
            </div>
