...
<main class="container col-12 col-lg-8 text-light">
    <div class="row col-12">
        <div class="col-12">
            <h1 class="font-weight-bold">Venda dos ingressos Lollapalooza 2023</h1>
            <h6 class="font-weight-normal">Está disponível a compra dos ingressos para o evento que ocorrerá no ano que vem</h6>
            <div class="mt-4">
            ...
            <hr class="bg-light">
            <div>
                <img src="contents/lollapalooza-2023.jpg" alt="lollapalooza" class="w-100 mb-2">
            ...
            <div>
                <img src="contents/lollashows.jpg" alt="lollapalooza-shows" class="w-100 mb-2">
