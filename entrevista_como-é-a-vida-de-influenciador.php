...
<main class="container col-12 col-lg-8 text-light">
    <div class="row col-12">
        <div class="col-12">
            ...
            <h6 class="font-weight-normal subtitulo">Nessa entrevista o influenciador e youtuber Chris fala sobre aspectos da sua profissão.</h6>
            <div class="pt-4">
            ...
            <div class="paragrafo-artigo">
                <p>- Um influenciador tem um papel muitas vezes muito importante, já que em muitos casos ele estimula as pessoas a adotarem um costume, comportamento, mudam a visão de mundo e das coisas para a pessoa muitas vezes, a estimulam a comprar coisas, a começar algo na sua vida, as colocam para cima, sendo carismáticos e gerando um lado mais amigo de ser e trazendo essas pessoas para seu lado e das marcas que te apoiam e patrocinam, gerando uma base de fãs. </p>
            </div>
            <div class="paragrafo-artigo">
                <p>Com essa resposta a próxima pergunta foi sobre a vida de um influenciador:</p>
            </div>
            <div class="paragrafo-artigo">
                <p>- A vida de um influenciador depende muito com questões de rotina, já que são dados trabalhos que podem vir do próprio criador de conteúdo quanto de marcas e empresas de fora que podem vir a te contratar ou chamar para fazer um trabalho ou para falar e mostrar mais sobre a marca deles, mas é uma rotina de muito trabalho e de muita atenção e estudo sobre o dia a dia e estar ligado nas coisas que estão acontecendo no meio que você se baseia para criar conteúdo. </p>
            </div>
            <div class="paragrafo-artigo">
            ...
            <div class="paragrafo-artigo">
                <p>- Minha vida é bem movimentada, com muitas viagens para eventos e encontros com outras pessoas para criar conteúdo, além disso faço muitos vídeos e stories sobre muitos conteúdos e marcas diferentes, eu gosto da minha vida mesmo que seja bem movimentada pois eu consigo aproveitar e conhecer muitos lugares e coisas sobre o mundo e as coisas que eu gosto. </p>
            </div>
            <div class="paragrafo-artigo">
