...
<main class="container col-12 col-lg-8">
    <div class="row col-12">
        ...
        <h5 class="h5not col-12" >Afinal, o evento foi bom? </h5>
        <img class="imgum" src="./contents/RockandRio22.jpg" alt="Rock and Rio 2022">
        <div class="textoimagem"><h4 class="textolegal text-justify" style="color: white;">Palco do Rock and Rio 2022</h4></div>
