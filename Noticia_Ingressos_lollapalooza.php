...
<main class="container col-12 col-lg-8">
    <div class="row col-12">
        <h1 class="h1not font-weight-bold" >Venda dos ingressos Lollapalooza 2023</h1>
        ...
        <img class="imgum mt-3" src="./contents/lollashows.jpg" alt="lollapalooza shows">
        <div class="textoimagem"><h4 class="textolegal text-justify" style="color: white;">Lollapalooza shows </h4></div>
